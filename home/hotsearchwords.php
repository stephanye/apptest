...
// $access_link = 'http://localhost/pwbbs2014/api/app/index.php?r=home/hotsearchwords&v=4.2.1';
$access_link = 'http://testbbs.xizi.com/api/app/index.php?r=home/hotsearchwords&v=4.2.1';
$data_params = [
	'params' => [
		'type' => 0,
		'lastid' => 31973,
