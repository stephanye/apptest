...
$access_link = 'http://localhost/pwbbs2014/api/app/index.php?r=thread/editcontent&v=4.2.1';
// $access_link = 'http://www.xiziquan.com/index.php?r=thread/editContent&v=4.2.1';
// $access_link = 'http://testbbs.xizi.com/api/app/index.php?r=thread/editContent&v=4.2.1';
//3959424 4015892  3399590
$data_params = [
	'params' => [
		'tid' => 3269887,
        'onlyreply' => 0,
